...
// replacing it with a preview (first 3000 chars) for list page display.
// This reduces data transfer from PostgreSQL while still providing enough
// content for preview text and thumbnail extraction.
